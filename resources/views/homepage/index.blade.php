    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h2 data-aos="fade-up">Discover your potential,
            improve your skills!</h2>
          <p data-aos="fade-up" data-aos-delay="100">Join us in Organisasi Kemahasiswaan Intra in Polinema which Lembaga tinggi, Himpunan mahasiswa jurusan, and unit kegiatan mahasiswa</p>

            <a href="/oki" class="btn btn-primary mb-2" data-aos="fade-up" data-aos-delay="200">Join Now!!</a>
        ...
        <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
          <img src="assets-homepage/img/hero-img.svg" class="img-fluid mb-3 mb-lg-0" alt="">
        </div>
  ...
  <main id="main">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up">
            ...
            <div>
              ...
              <a href="/oki#LembagaTinggi" class="readmore stretched-link"><span>Learn More</span><i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
          <!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
            ...
            <div>
              ...
              <a href="/oki#HimpunanMahasiswaJurusan" class="readmore stretched-link"><span>Learn More</span><i class="bi bi-arrow-right"></i></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="200">
            ...
            <div>
              ...
              <a href="/oki#UnitKegiatanMahasiswa" class="readmore stretched-link"><span>Learn More</span><i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
    ...
    <section id="service" class="services pt-0">
      <div class="container" data-aos="fade-up">
        ...
        <div class="mt-5 mt-5 section-header">
      ...
      <div class="container" data-aos="zoom-out">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <a class="cta-btn" href="/oki">Join Now</a>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4 align-items-center features-item"  data-aos="fade-up">
          ...
          <div class="col-md-7">
            ...
            <p class="fst-italic">
              "Unit Kegiatan Mahasiswa" or what is usually abbreviated as UKM is an organization that accommodates the potential/advantages of students. There are many UKM organizations at POLINEMA.
            </p>
            <ul>
              <li><i class="bi bi-check"></i> Ullamco laboris nisi ut aliquip ex ea commodo consequat.</li>
              <li><i class="bi bi-check"></i> Duis aute irure dolor in reprehenderit in voluptate velit.</li>
